...
public class ValidationRulesCache {
	...
	private final ValidationRuleParamsDAO validationRuleParamsDAO;
	...
	public ValidationRulesCache(RedisTemplate<String, String> redisTemplate, 
			ValidationRuleDAO validationRuleDAO, ValidationRuleParamsDAO validationRuleParamsDAO) {
		this.redisTemplate = redisTemplate;
		this.listOperations = redisTemplate.opsForList();
		this.hashOperations = redisTemplate.opsForHash();
		this.validationRuleDAO = validationRuleDAO;
		this.validationRuleParamsDAO = validationRuleParamsDAO;
	}
	...
	public Map<String, String> getValidationRulesParams(String validatorRuleName) {
		...
		validatorRuleParams = validationRuleParamsDAO.loadValidatorRuleParams(validatorRuleName);
